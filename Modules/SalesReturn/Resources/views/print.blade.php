...
<head>
    ...
    <title>Detail Pengembalian Penjualan</title>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row mb-4">
                        ...
                        <div class="col-xs-4 mb-3 mb-md-0">
                            <h4 class="mb-2" style="border-bottom: 1px solid #dddddd;padding-bottom: 10px;">Informasi Pelanggan:</h4>
                        ...
                        <div class="col-xs-4 mb-3 mb-md-0">
                            <h4 class="mb-2" style="border-bottom: 1px solid #dddddd;padding-bottom: 10px;">Informasi Tagihan:</h4>
                            <div>Tagihan: <strong>INV/{{ $sale_return->reference }}</strong></div>
                    ...
                    <div class="table-responsive-sm" style="margin-top: 30px;">
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <th class="align-middle">Total Jumlah</th>
                            </tr>
                            </thead>
                            <tbody>
