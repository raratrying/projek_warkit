                    ...
                    <div class="card-body">
                        ...
                        <form id="purchase-return-form" action="{{ route('purchase-returns.update', $purchase_return) }}" method="POST">
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status" required>
                                            <option {{ $purchase_return->status == 'Pending' ? 'selected' : '' }} value="Pending">Diproses</option>
                                            <option {{ $purchase_return->status == 'Shipped' ? 'selected' : '' }} value="Shipped">Dikirim</option>
                                            <option {{ $purchase_return->status == 'Completed' ? 'selected' : '' }} value="Completed">Selesai</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="paid_amount">Total Tagihan<span class="text-danger">*</span></label>
                            ...
                            <div class="form-group">
                                <label for="note">Catatan (Jika Butuh)</label>
                                <textarea name="note" id="note" rows="5" class="form-control">{{ $purchase_return->note }}</textarea>
                            </div>

                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary">
                                    Perbarui Pengembalian Pembelian <i class="bi bi-check"></i>
                                </button>
                            </div>
                        </form>
                    </div>
